...
jsPsych.plugins['demo-langfluency-CN'] = (function () {
	var plugin = {};

	plugin.info = {
		name: 'demo-langfluency-CN',
		description: '',
		parameters: {
			preamble: {
	...
	plugin.trial = function (display_element, trial) {
		...
		// add submit button
		trial_form.innerHTML += '<input type="submit" id="' + plugin_id_name + '-next" class="' + plugin_id_name + ' jspsych-btn" value="完成！"></input>';
