...
jsPsych.plugins['funnel-debriefing-specific'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'funnel-debriefing-specific',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '<div class="jspsych-survey-text" style="margin: 0.1em 0em;">' + question.prompt + '</div>';
