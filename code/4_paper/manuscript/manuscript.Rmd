...
We note that language statistics can incorporate both cultural-specific environmental statistics (the inputs of similarity judgment) and thematic/taxonomic preferences (the conceptualization of similarity).
...
Q4: Is the relationship with co-occurrence specific to thematic/taxonomic items, or can co-occurrence structure predict other judgments? 
...
Language statistics are also a good predictor for filler items with no thematic/taxonomic structure.
