...
Alternatively, these judgments could be shaped by cross-cultural differences in the *inputs* to similarity judgment, that is, the statistics of the environment, and the content of everyday experiences.
...
We might also expect that both conceptualization of similarity and inputs from experience play a role in driving cross-cultural differences -- East Asian participants may be exposed to more instances of thematic similarity, and prefer to conceptualize similarity as thematic to a greater extent than Westerners.
