...
@Ji2004 suggest that the notion of similarity is what varies across cultural groups, but it is quite possible that similarity is regarded in the same way and it is actually the input to this similarity judgment that varies across culture contexts. It might be possible to gain traction on possible mechanisms by examining whether variation in similarity judgments co-varies with environmental statistics that differ across the cultural and linguistic contexts.
...
icc_item_US <- icc(df.icc_item_US, model = "twoway", type = "consistency", unit = "single")$value
