...
>>>>>>> bf4e0b298fc2c003005df2dfc82497b452e03a6c
...
questions.
=======
recruited 200 participants from the US, 199 from Vietnam, and 200 from
mainland China. All participants were recruited through snowball
sampling, which, in the US was seeded with student email lists at a
large university, in Vietnam (VN) with Vietnam-based student groups on
Facebook, and in China (CN) with student groups on WeChat. US
participants were compensated with \$5 gift certificates (USD), VN
participants received 50,000₫ (VND) in phone credit, and CN participants
received 25CNY through WeChat credit transfer.

We excluded 8 US participants, 62 VN participants, and 16 CN
participants who missed two or more of the 10 attention check questions.
>>>>>>> bf4e0b298fc2c003005df2dfc82497b452e03a6c
...
=======
Any differences are noted in the Analysis.
>>>>>>> bf4e0b298fc2c003005df2dfc82497b452e03a6c
...
=======
As a result of these demographic exclusions, we excluded 73 US, 27 VN,
and 35 CN participants. The final US sample included 119 participants
(30M, 84F, 3 non-binary, 2 other), with mean age = 22.2 (SD = 8.15). Our
VN sample included 110 participants (34M, 71F, 5 other), with mean age =
22.21 (SD = 5.81). And the CN sample included 149 participants (61M,
87F, 1 other), with mean age = 23.1 (SD = 3.65).{[}\^{}4{]}
>>>>>>> bf4e0b298fc2c003005df2dfc82497b452e03a6c
...
\end{CJK*}
=======
Each participant completed all 105 triads in blocks of 21 trials at a
time (10 test triads, 10 filler triads, and 1 attention check per page),
by selecting the match most related to the cue (``Which thing is most
...
thematic vs.~taxonomic similarity, for example, the cue ``bird'' with
match options ``lizard'' and ``toad.'' Additionally, we included 10
attention check trials, which were formatted similarly to the test and
filler triads but included an instruction instead of a cue item, e.g.,
``Choose wife'' with match options ``wife'' and ``husband.'' In total,
each participant completed 210 similarity judgments (105 test triads and
105 fillers) and 10 attention check questions, with all items presented
in randomized orders that varied between subjects.
>>>>>>> bf4e0b298fc2c003005df2dfc82497b452e03a6c
...
US and CN responding (\(\beta\) = -0.48, p \textless{} .001). There was
no statistical difference between matching in Vietnam and China
(\(\beta\) = -0.22, p = 0.09), or the US and Vietnam (\(\beta\) = 0.26,
p = 0.086).
>>>>>>> bf4e0b298fc2c003005df2dfc82497b452e03a6c
