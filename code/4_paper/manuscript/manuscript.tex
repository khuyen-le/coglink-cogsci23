...
be good predictors for similarity judgments (Jatnika, Bijaksana, \&
Suryani, 2019; Liu, Feng, Wu, Chan, \& Fulton, 2019).
...
thematic/taxonomic preferences (the conceptualization of similarity).
...
thematic/taxonomic items, or can co-occurrence structure predict other
judgments?~
...
predictor for filler items with no thematic/taxonomic structure. Our
