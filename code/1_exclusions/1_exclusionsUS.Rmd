...
percent_dropped #0.4425287 # will not use this criterion
...
length(unique(df.resp_E_aft_demog$subject)) #124
...
# colnames(df.demog_metadata) <- c("Participants Finished", "Participants ")
```

```{r}
write.csv(df.resp_E_aft_demog, "../../data/responding/dataUS_excl.csv")
